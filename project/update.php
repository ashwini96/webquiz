...
$desc = $_POST['desc'];
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO quiz VALUES  ('$id','$name' , '$rig' , '$wrong','$total','$time' ,'$desc','$tag', NOW())");
...
$r++;
$s=$s+$rig;
$q=mysqli_query($con,"UPDATE `history` SET `score`=$s,`level`=$sn,`rig`=$r, date= NOW()  WHERE  email = '$email' AND eid = '$eid'")or die('Error124');
