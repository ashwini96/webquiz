...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Navigation</b></a>
    </div>
...
if($rowcount == 0){
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$rig*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$rig*$total.'</td><td>'.$time.'&nbsp;min</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<!-- <div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<h4  style="color:#202020; font-family:'typo' ; font-size:18px" >Ashwini</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">1234567890</h4>
		<h4 style="font-family:'typo' ">abg123@gmail.com</h4>
		<h4 style="font-family:'typo' ">Raja Reddy Insitute of Technology</h4></div></div>
		</p>
      </div> -->
